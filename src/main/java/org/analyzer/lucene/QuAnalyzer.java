...
public final class QuAnalyzer extends Analyzer {

	private Logger logger = LogManager.getLogger(QuAnalyzer.class);

	private Settings settings;

	public QuAnalyzer(Settings settings){
		this.settings = settings;
	}

	@Override
	protected TokenStreamComponents createComponents(String fieldName) {
		logger.info("TokenStreamComponents createComponents(String fieldName)");
		QuTokenizer tokenizer = (null == settings) ? new QuTokenizer() : new QuTokenizer(settings);
